...
const OrderTable = ({ tableInstance, orders }) => {
    ...
    return (
        <div className='border border-gray-300 rounded-md shadow-[0px_0px_15px_0px_rgba(0,0,0,0.15)]'>
            ...
            <div className='flex justify-between items-center mr-6'>
                ...
                <div>
                    <h4 className='text-base text-gray-600 font-poppins font-semibold'>Total Order : <span className='text-gray-500'>{orders?.length}</span></h4>
                </div>
            </div>
